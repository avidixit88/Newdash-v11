...
st.plotly_chart(charts.partner_landscape_chart(df), use_container_width=True, config=charts.CHART_CONFIG)
st.plotly_chart(charts.partner_agent_chart(df), use_container_width=True, config=charts.CHART_CONFIG)
st.plotly_chart(charts.strategic_signal_stack_chart(df), use_container_width=True, config=charts.CHART_CONFIG)
